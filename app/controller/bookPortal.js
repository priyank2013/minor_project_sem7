(function() {
    ...
    var bookPortal = function($scope, $http, $rootScope, $localStorage) {
    ...
    bookPortal.$inject = ['$scope', '$http', '$rootScope','$localStorage'];
    var ngStore = angular.module
    angular.module('bookPortal').controller('bookPortal', bookPortal);
